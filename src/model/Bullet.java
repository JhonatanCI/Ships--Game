...
public class Bullet {
	...
	public Bullet(Canvas canvas,int x,int y) {
		...
		this.size = 60;
		this.speed = 3;
		File file1 = new File("src/images/PNG_Parts&Spriter_Animation/Explosions/Explosion1/Explosion1_1.png");
		File file2 = new File("src/images/PNG_Parts&Spriter_Animation/Explosions/Explosion1/Explosion1_2.png");
		try {
